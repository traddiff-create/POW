  ...
  public: {
    Tables: {
      ...
      journal_entries: {
        ...
        Insert: { user_id: string; week_number?: number | null; title?: string | null; body?: string | null; source_resource_id?: string | null };
        Update: { title?: string | null; body?: string | null; source_resource_id?: string | null; updated_at?: string };
        Relationships: never[];
      };
      circle_shares: {
        Row: {
