    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section className="px-6 py-24 max-w-3xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl mb-6" style={{ fontFamily: "Georgia, serif" }}>
            From self to each other.
          </h1>
          <p className="text-lg text-[#2C2A28]/70 mb-10 max-w-xl mx-auto">
          ...
          <Link
            href="/apply"
            className="inline-block bg-[#7A9E7E] text-white px-8 py-4 text-base hover:opacity-90 transition-opacity"
          >
            Apply to Join
          </Link>
        </section>
        ...
        <section className="px-6 py-16 max-w-2xl mx-auto">
          <h2 className="text-2xl mb-8" style={{ fontFamily: "Georgia, serif" }}>What it is</h2>
          <p className="text-[#2C2A28]/80 mb-5 leading-relaxed">
          ...
          <p className="text-[#2C2A28]/80 leading-relaxed">
        ...
        {/* How it works */}
        <section className="px-6 py-16 bg-[#2C2A28]/5">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl mb-10" style={{ fontFamily: "Georgia, serif" }}>How it works</h2>
            <div className="space-y-8">
              {[
                ...
                <div key={n} className="flex gap-6">
                  <div className="text-3xl text-[#C4A882]" style={{ fontFamily: "Georgia, serif" }}>{n}</div>
                  <div>
                    <h3 className="font-medium mb-1">{title}</h3>
                    <p className="text-[#2C2A28]/70">{body}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Who it's for */}
        <section className="px-6 py-16 max-w-2xl mx-auto">
          <h2 className="text-2xl mb-6" style={{ fontFamily: "Georgia, serif" }}>Who it&apos;s for</h2>
          <p className="text-[#2C2A28]/80 leading-relaxed">
        ...
        {cohorts.length > 0 && (
          <section className="px-6 py-16 bg-[#2C2A28]/5">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl mb-8" style={{ fontFamily: "Georgia, serif" }}>Open cohorts</h2>
              <div className="grid md:grid-cols-3 gap-6">
                {cohorts.map((cohort) => (
                  <div key={cohort.id} className="bg-[#F9F7F4] border border-[#2C2A28]/10 p-6">
                    <h3 className="font-medium mb-2">{cohort.name}</h3>
                    {cohort.start_date && (
                      <p className="text-sm text-[#2C2A28]/60 mb-4">
                    ...
                    <Link href={`/cohorts/${cohort.slug ?? cohort.id}`} className="text-sm text-[#7A9E7E] underline">
                      Learn more →
                    </Link>
                  </div>
                ))}
              ...
              <p className="mt-8 text-center">
                <Link href="/cohorts" className="text-sm text-[#7A9E7E] underline">
                  See all cohorts →
                </Link>
              </p>
            </div>
